# Capability: license-product

## Purpose
License product management backend capability. Provides CRUD operations for products (including code uniqueness, status machine, ConstraintSchema definition), Ed25519 key pair management (encrypted storage, key rotation), seed data (menus and Casbin policies), and REST API routes under the license App.
