# Capability: license-product-ui

## Purpose
License product management frontend capability. Provides product list page, product detail page (with tabs for basic info, plans, constraint schema editor, and key management), ConstraintSchema visual editor, plan forms with dynamic constraint value rendering, and frontend route/menu registration in the license App module.
